  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "CORS_ALLOWED_ORIGINS", value = join(",", concat(["https://${var.web_portal_subdomain}"], [for d in var.web_portal_extra_domains : "https://${d}"], ["https://${var.marketing_domain}", "https://www.${var.marketing_domain}"])) },
