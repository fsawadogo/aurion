...
- [ ] TE-2 · Load the template into Stage 2 (plumbing only) — 1d — lane: backend — no blockers — prerequisite for TE-3/TE-4; reuse `stored_template_pin` + `_resolve_stage1_template`, zero behavior change
