...
Last seeded: 2026-05-14. Last updated: 2026-07-15 (added Cohort 6 — Template Functional Loop; demoted Cohort 5 per the 2026-07-15 weekly; Template Engine v2 / Heidi parity exists as a PLAN ONLY — docs/plans/template-engine-v2.md, NOT queued per Faïçal "just the doc for now"; do not seed it as a cohort without his go). Prior: 2026-07-01 (added Cohort 5 — Grounded AI Scribe: #620–#625; see memory/grounded-scribe-gap-map.md). Prior: 2026-05-30 (seeded 17 backend issues from GitHub per CTO's "implement all backend" directive).
